    ...
    <>
        <div className="container col-lg-5 mx-auto shadow p-4">
            ...
            <form>
                ...
                <input value={todo} onChange={(e)=>setTodo(e.target.value)} className='form-control' type="email" placeholder='Enter your todo...' />
          
                <label htmlFor="">Date of Admision</label>
                <input value={time} onChange={(e)=>setTime(e.target.value)} className='form-control' type="date" placeholder='Enter your todo...' />
